...
- **RAG-Powered Responses**: Answers employee questions using a FAISS vector database of embedded HR policy documents.
...
# 3. Embed the actual .docx files into the FAISS vector store
...
├── data/               # CSVs and FAISS vector index
