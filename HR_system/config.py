...
# --------------- RAG ---------------
DOCS_DIR = os.path.join(os.path.dirname(__file__), "DocsHR")
...
DEPARTMENTS = {
    "people_team": {
        ...
        "system_prompt": (
            "You are the People Team at a company. You handle employee relations, "
    ...
    "payroll": {
        ...
        "sign_off": "Payroll Team",
        "system_prompt": (
            "You are the Payroll department at a company. "
    ...
    "benefits": {
        ...
        "system_prompt": (
            "You are the Benefits department at a company. "
    ...
    "talent_development": {
        ...
        "sign_off": "Talent Development Team",
        "system_prompt": (
            "You are the Talent Development department at a company. "
    ...
    "onboarding": {
        ...
        "sign_off": "Onboarding Team",
        "system_prompt": (
            "You are the Onboarding department at a company. "
    ...
    "compliance": {
        ...
        "sign_off": "Compliance Team",
        "system_prompt": (
            "You are the Compliance department at a company. "
    ...
    "recruitment": {
        ...
        "sign_off": "Recruitment Team",
        "system_prompt": (
            "You are the Recruitment department at a company. "
    ...
    "it_support": {
        ...
        "sign_off": "IT Support Team",
        "system_prompt": (
            "You are the IT Support department at a company. "
