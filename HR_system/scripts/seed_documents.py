...
"""
Seed hr_documents and hr_escalation_rules from ../data/hr_document_data.csv.
...
from app.db.database import init_db, SessionLocal, HRDocument, HREscalationRule

CSV_PATH = os.path.join(os.path.dirname(__file__), "../data/hr_document_metadata.csv")
        ...
        with open(CSV_PATH, newline="") as f:
            ...
            for row in reader:
                ...
                doc = HRDocument(
                    ...
                    document_url=row.get("dummy_url", "").strip() or None,
