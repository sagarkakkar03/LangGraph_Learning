...
Seed the full Postgres database:
  1. Employees + Departments  (from ../data/employee_data.csv)
...
from app.db.database import init_db, SessionLocal, Department, Employee
from dotenv import load_dotenv
load_dotenv()

DATABASE_URL = os.getenv("DATABASE_URL")
CSV_PATH = os.path.join(os.path.dirname(__file__), "../data/employee_data.csv")
